...
NEWS_API = "fb053cf22f204148b674c7fe82e5f456"
...
def world_news():
    ...
    r = requests.get(
        f"https://newsapi.org/v2/top-headlines?language=en&apiKey={NEWS_API}"
    )

    return r.json()["articles"][:10]
...
def local_news(city):
    ...
    r = requests.get(
        f"https://newsapi.org/v2/everything?q={city}&apiKey={NEWS_API}"
    )
